...
/// </summary>
public interface IOrderServiceRepository : IRepository<ServiceOrder>
{
    /// <summary>
    ...
    Task<(IEnumerable<ServiceOrder> Items, int TotalCount)> GetFilteredAsync(OrderServiceQueryParams query);
}
